...
import { ChainId, WDEX, FACTORY_ADDRESS } from 'zswap-sdk'
import { abi as IUniswapV2PairABI } from '@uniswap/v2-core/build/IUniswapV2Pair.json'
import ENS_PUBLIC_RESOLVER_ABI from 'config/abi/ens-public-resolver.json'
import ENS_ABI from 'config/abi/ens-registrar.json'
import { ERC20_BYTES32_ABI } from 'config/abi/erc20'
import ERC20_ABI from 'config/abi/erc20.json'
import WDEX_ABI from 'config/abi/weth.json'
...
import {
  ZSWAP_LP_ADDRESS,
  ZSWAP_STAKE_ADDRESS,
  ZSWAP_MUTLICALL_ADDRESS,
  ZSWAP_LOTTERY_ADDRESS,
} from 'config/constants/zswap/address'
...
export function useWDEXContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId ? WDEX[chainId].address : undefined, WDEX_ABI, withSignerIfPossible)
}
