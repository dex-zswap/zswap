...
const StyledButton = styled.button<BaseButtonProps>`
  ...
  &:hover:not(:disabled):not(.zswap-button--disabled):not(.zswap-button--disabled):not(:active) {
    opacity: 0.65;
  }

  &:active:not(:disabled):not(.zswap-button--disabled):not(.zswap-button--disabled) {
    opacity: 0.85;
