...
import { Button, Text, PancakeToggle, Flex, Message, Modal, ModalBody, InjectedModalProps } from 'zswap-uikit'
import {
  useAudioModeManager,
...
const SettingsModal: React.FC<InjectedModalProps> = ({ onDismiss }) => {
  ...
  return (
    ...
    >
      <ModalBody>
        <AutoColumn gap="md" style={{ padding: '0 0 1rem 0' }}>
          ...
          <RowBetween>
            <RowFixed>
              <Text >{t('Toggle Expert Mode')}</Text>
              <QuestionHelper
