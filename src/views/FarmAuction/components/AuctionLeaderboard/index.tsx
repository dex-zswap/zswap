...
import { Text, Card, Flex, Box, Spinner } from 'zswap-uikit'
import { useTranslation } from 'contexts/Localization'
import { Auction, AuctionStatus, Bidder } from 'config/constants/types'
import { TabToggleGroup, TabToggle } from 'views/FarmAuction/components/TabToggle'
import AuctionHistory from 'views/FarmAuction/components/AuctionHistory'
